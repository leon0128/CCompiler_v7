...
Tokenizer::Tokenizer(const std::vector<Token*> &tvec
    , std::size_t &idx)
    : mTvec(tvec)
    , mIdx(idx)
{
...
TranslationUnit *Tokenizer::tokTranslationUnit()
{
...
ExternalDeclaration *Tokenizer::tokExternalDeclaration()
{
...
FunctionDefinition *Tokenizer::tokFunctionDefinition()
{
...
Declaration *Tokenizer::tokDeclaration()
{
    Declaration ret;
    std::size_t preidx = mIdx;
...
DeclarationSpecifiers *Tokenizer::tokDeclarationSpecifiers()
{
...
Declarator *Tokenizer::tokDeclarator()
{
    Declarator ret;
    std::size_t preidx = mIdx;
...
DeclarationList *Tokenizer::tokDeclarationList()
{
...
CompoundStatement *Tokenizer::tokCompoundStatement()
{
...
InitDeclaratorList *Tokenizer::tokInitDeclaratorList()
{
...
StaticAssertDeclaration *Tokenizer::tokStaticAssertDeclaration()
{
...
StorageClassSpecifier *Tokenizer::tokStorageClassSpecifier()
{
...
TypeSpecifier *Tokenizer::tokTypeSpecifier()
{
    TypeSpecifier ret;
...
TypeQualifier *Tokenizer::tokTypeQualifier()
{
    TypeQualifier ret;
...
FunctionSpecifier *Tokenizer::tokFunctionSpecifier()
{
...
AlignmentSpecifier *Tokenizer::tokAlignmentSpecifier()
{
...
DirectDeclarator *Tokenizer::tokDirectDeclarator()
{
...
BlockItemList *Tokenizer::tokBlockItemList()
{
...
InitDeclarator *Tokenizer::tokInitDeclarator()
{
    InitDeclarator ret;
    std::size_t preidx = mIdx;
...
StringLiteral *Tokenizer::tokStringLiteral()
{
...
AtomicTypeSpecifier *Tokenizer::tokAtomicTypeSpecifier()
{
...
StructOrUnionSpecifier *Tokenizer::tokStructOrUnionSpecifier()
{
...
EnumSpecifier *Tokenizer::tokEnumSpecifier()
{
    EnumSpecifier ret;
    std::size_t preidx = mIdx;
    ...
    if(isMatch(Keyword::Tag::ENUM)
        ...
        return new EnumSpecifier();
    else
        return mIdx = preidx, nullptr;
}

TypedefName *Tokenizer::tokTypedefName()
{
    TypedefName ret;
...
TypeName *Tokenizer::tokTypeName()
{
    TypeName ret;
    std::size_t preidx = mIdx;
...
TypeQualifierList *Tokenizer::tokTypeQualifierList()
{
...
::Identifier *Tokenizer::tokIdentifier()
{
...
ParameterTypeList *Tokenizer::tokParameterTypeList()
{
...
IdentifierList *Tokenizer::tokIdentifierList()
{
...
BlockItem *Tokenizer::tokBlockItem()
{
    BlockItem ret;
...
Initializer *Tokenizer::tokInitializer()
{
    Initializer ret;
    std::size_t preidx = mIdx;
...
StructOrUnion *Tokenizer::tokStructOrUnion()
{
    StructOrUnion ret;
...
StructDeclarationList *Tokenizer::tokStructDeclarationList()
{
...
EnumeratorList *Tokenizer::tokEnumeratorList()
{
...
SpecifierQualifierList * Tokenizer::tokSpecifierQualifierList()
{
...
AbstractDeclarator *Tokenizer::tokAbstractDeclarator()
{
...
AssignmentOperator *Tokenizer::tokAssignmentOperator()
{
...
ParameterList *Tokenizer::tokParameterList()
{
...
Statement *Tokenizer::tokStatement()
{
    Statement ret;
...
InitializerList *Tokenizer::tokInitializerList()
{
...
StructDeclaration *Tokenizer::tokStructDeclaration()
{
...
Enumerator *Tokenizer::tokEnumerator()
{
    Enumerator ret;
    std::size_t preidx = mIdx;
...
DirectAbstractDeclarator *Tokenizer::tokDirectAbstractDeclarator()
{
...
UnaryOperator *Tokenizer::tokUnaryOperator()
{
    UnaryOperator ret;
...
ParameterDeclaration *Tokenizer::tokParameterDeclaration()
{
...
LabeledStatement *Tokenizer::tokLabeledStatement()
{
...
ExpressionStatement *Tokenizer::tokExpressionStatement()
{
...
SelectionStatement *Tokenizer::tokSelectionStatement()
{
...
IterationStatement *Tokenizer::tokIterationStatement()
{
...
JumpStatement *Tokenizer::tokJumpStatement()
{
    JumpStatement ret;
    std::size_t preidx = mIdx;
...
Designation *Tokenizer::tokDesignation()
{
    Designation ret;
    std::size_t preidx = mIdx;
...
StructDeclaratorList *Tokenizer::tokStructDeclaratorList()
{
...
EnumerationConstant *Tokenizer::tokEnumerationConstant()
{
...
ArgumentExpressionList *Tokenizer::tokArgumentExpressionList()
{
    std::vector<AssignmentExpression*> aevec;
    std::size_t preidx = mIdx;
    AssignmentExpression *ae = tokAssignmentExpression();
...
DesignatorList *Tokenizer::tokDesignatorList()
{
...
StructDeclarator *Tokenizer::tokStructDeclarator()
{
...
Constant *Tokenizer::tokConstant()
{
...
GenericSelection *Tokenizer::tokGenericSelection()
{
...
Designator *Tokenizer::tokDesignator()
{
    Designator ret;
    std::size_t preidx = mIdx;
...
GenericAssocList *Tokenizer::tokGenericAssocList()
{
...
GenericAssociation *Tokenizer::tokGenericAssociation()
{
...
bool Tokenizer::isMatch(Punctuator::Tag tag, bool isConsumed)
{
    if(mIdx < mTvec.size()
...
bool Tokenizer::isMatch(Keyword::Tag tag, bool isConsumed)
{
    if(mIdx < mTvec.size()
...
bool Tokenizer::isMatch(Token::Tag tag, bool isConsumed)
{
    if(mIdx < mTvec.size()
        && mTvec[mIdx]->tag == tag)
    {
